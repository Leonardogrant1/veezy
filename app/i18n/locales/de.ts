const de: Record<string, string> = {
  ...
  'vision.add.figure_gate_title': 'Zuerst brauchst du deine Figur',
  'vision.add.figure_gate_text': 'Aus 5 Fotos von dir erstellen wir deine persönliche Figur – sie ist die Basis für alle deine Visionsbilder.',
  'vision.add.figure_gate_button': 'Figur erstellen',
